 ...
 */
public class TecnologiaFragment extends Fragment implements JSON,NoticiaAdapter.OnItemClickListener{
    View view;
    private RecyclerView mRecyclerView;
    private ArrayList<Noticia> noticiasTecnologia;
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for(int i = 0; i<jsonArray.length(); i++){
                        ...
                        noticiasTecnologia.add(new Noticia(res2,autor,titulo,descricao,data,url)); //adiciona elementos na lista
                    }

                    noticiaAdapter = new NoticiaAdapter(getContext(),noticiasTecnologia);
                    mRecyclerView.setAdapter(noticiaAdapter);
                    noticiaAdapter.setOnItemClickListener(TecnologiaFragment.this);
    ...
    public void onItemclick(int position) {
        ...
        Noticia noticia = noticiasTecnologia.get(position);
