 ...
 */
public class HomeFragment extends Fragment implements JSON,NoticiaAdapter.OnItemClickListener {
    View view;
    private RecyclerView mRecyclerView;
    private ArrayList<Noticia> principais;
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for(int i = 0; i<jsonArray.length(); i++){
                        ...
                        principais.add(new Noticia(res2,autor,titulo,descricao,data,url)); //adiciona elementos na lista
                    }

                    noticiaAdapter = new NoticiaAdapter(getContext(),principais);
                    mRecyclerView.setAdapter(noticiaAdapter);
                    noticiaAdapter.setOnItemClickListener(HomeFragment.this);
    ...
    public void onItemclick(int position) {
        ...
        Noticia noticia = principais.get(position);
